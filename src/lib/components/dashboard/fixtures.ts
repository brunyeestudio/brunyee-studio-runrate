...
export const sampleSnapshot: DashboardSnapshot = {
	...
	kpis: {
		...
		outstandingBalance: {
			...
			count: 2,
			byCurrency: [
				{ currencyCode: 'GBP', amount: 4200, convertedAmount: 4200, count: 1 },
				{ currencyCode: 'EUR', amount: 1000, convertedAmount: 850, count: 1 }
			]
		},
		issuedOnMonthStart: { amount: 0, source: 'Issued', count: 0, byCurrency: [] },
		issuedThisMonth: { amount: 0, source: 'Issued', count: 0, byCurrency: [] }
	},
	paymentTiming: {
		dueThisMonth: {
			amount: 5050,
