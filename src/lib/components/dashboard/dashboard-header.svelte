...
<header class="flex flex-wrap items-end justify-between gap-4" data-testid="dashboard-header">
	<div class="space-y-1">
		<p class="text-muted-foreground text-[0.625rem] font-semibold tracking-[0.2em] uppercase">
			Brunyee Studio
		</p>
		<h1 class="text-3xl font-medium tracking-tight">Runrate</h1>
		<p class="text-muted-foreground text-sm">In-month overview · {monthLabel}</p>
	</div>
