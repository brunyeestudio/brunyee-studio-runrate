...
**Runrate** is a in-month run-rate and receivables dashboard for Brunyee Studio. It reads Zoho Books invoices and unbilled hourly project WIP so the user can see whether they are on target for the current month.
